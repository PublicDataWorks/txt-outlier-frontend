      ...
      <DialogContent className="bg-background border border-input dark:bg-[#1E1E1E] dark:border-neutral-700">
          ...
          <div className="flex justify-center">
            <Calendar
              ...
              classNames={{
                ...
                caption:
                  'flex justify-center pt-1 relative items-center text-muted-foreground dark:text-neutral-200',
                caption_label: 'text-sm font-medium',
                nav: 'space-x-1 flex items-center',
                nav_button:
                  'h-7 w-7 bg-transparent p-0 opacity-70 hover:opacity-100 hover:bg-input/50 rounded-md dark:hover:bg-neutral-700',
                nav_button_previous: 'absolute left-1',
                nav_button_next: 'absolute right-1',
                table: 'w-full border-collapse space-y-1',
                head_row:
                  'flex justify-between px-2 border-b border-input dark:border-neutral-700',
                head_cell:
                  'text-muted-foreground rounded-md w-9 font-normal text-sm dark:text-neutral-400',
                ...
                day_selected:
                  'bg-[#2F80ED] text-white hover:bg-[#2D7BE5] rounded-md dark:bg-[#2F80ED] dark:text-white',
                day_today:
                  'bg-input/50 text-muted-foreground dark:bg-neutral-700 dark:text-neutral-200',
                day_outside:
                  'text-muted-foreground opacity-50 dark:text-neutral-500',
                day_disabled:
                  'text-muted-foreground opacity-50 dark:text-neutral-500',
        ...
        <DialogFooter>
          <Button
            ...
            disabled={isLoading}
          >
            {isLoading ? <LoadingSpinner /> : 'Reschedule'}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
